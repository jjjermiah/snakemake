...
## [8.4.1](https://github.com/jjjermiah/snakemake/compare/v8.12.0...v8.4.1) (2024-06-04)


### ⚠ BREAKING CHANGES

* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/jjjermiah/snakemake/issues/2403))

### Features

* add --sdm short opt for --deployment ([#2551](https://github.com/jjjermiah/snakemake/issues/2551)) ([fd8b4b0](https://github.com/jjjermiah/snakemake/commit/fd8b4b08da778097071ea8c32c95e21e610c6614))
* add ability to inject conda environments into running Snakefile ([#2479](https://github.com/jjjermiah/snakemake/issues/2479)) ([6140e29](https://github.com/jjjermiah/snakemake/commit/6140e29864cf0fcdd83194f218408867c54b730d))
...
* add functionality for deploying sources if no shared FS is assumed ([#2486](https://github.com/jjjermiah/snakemake/issues/2486)) ([76eac3c](https://github.com/jjjermiah/snakemake/commit/76eac3c570624f818ff43f4759a27a3e284bf03c))
...
* add option to control software deployment mode (shared or non shared FS) ([#2525](https://github.com/jjjermiah/snakemake/issues/2525)) ([04ec2c0](https://github.com/jjjermiah/snakemake/commit/04ec2c0262b2cb96cbcd7edbbb2596979c1703ae))
...
* Add support for Google Service Accounts and GCE VM network configuration ([#2318](https://github.com/jjjermiah/snakemake/issues/2318)) ([2b754aa](https://github.com/jjjermiah/snakemake/commit/2b754aae535ef76bd2dd34bc31d5c9f5c69363de))
* add support for Kubernetes service account name spec ([#2254](https://github.com/jjjermiah/snakemake/issues/2254)) ([3370426](https://github.com/jjjermiah/snakemake/commit/3370426da7ee78af5de54689f623e2b5afa45f1f))
* added localrule directive ([#2180](https://github.com/jjjermiah/snakemake/issues/2180)) ([9c990b0](https://github.com/jjjermiah/snakemake/commit/9c990b076b51e9e2123ced56bfab176e03424770))
* allow config files to be processed with YTE ([#2269](https://github.com/jjjermiah/snakemake/issues/2269)) ([8e1c22f](https://github.com/jjjermiah/snakemake/commit/8e1c22ff54e85ee941c6e0ac74dd594fce80efbb))
...
* allow detailed configuration of shared FS usage ([#2528](https://github.com/jjjermiah/snakemake/issues/2528)) ([0d34be9](https://github.com/jjjermiah/snakemake/commit/0d34be90040f937021eb25becb4ef5d5aae66473))
* allow environment variables in string values of profile (e.g. paths may now contain elements like $USER). ([58dc70c](https://github.com/jjjermiah/snakemake/commit/58dc70c513d08cb217647ec591df93b40517b650))
...
* allow profiles to be YTE templates; adapt to eido 2.0 ([#2325](https://github.com/jjjermiah/snakemake/issues/2325)) ([67d9ff2](https://github.com/jjjermiah/snakemake/commit/67d9ff20ea61186d3818e7bc1d33e4414058fc1f))
* allow python expressions in --set-resources ([#2521](https://github.com/jjjermiah/snakemake/issues/2521)) ([022a31e](https://github.com/jjjermiah/snakemake/commit/022a31e0e75416904589c62b58e54c952d930c69))
...
* Allow the environment variable SNAKEMAKE_CONDA_PREFIX to be present without --use-conda ([#2263](https://github.com/jjjermiah/snakemake/issues/2263)) ([e4eba8d](https://github.com/jjjermiah/snakemake/commit/e4eba8d72b84aaa460c7d1b1ac54b607e844d782))
* allow to set latency_wait in executor test suite ([c0bca0b](https://github.com/jjjermiah/snakemake/commit/c0bca0bb8bf66fb34def7459f757140ce3825a25))
* automatically upload workflow sources to default storage provider if no shared FS is used ([a450c49](https://github.com/jjjermiah/snakemake/commit/a450c4998de3ab7deb0fb2bc19dc59fdc484309d))
* Azbatch executor ([#1953](https://github.com/jjjermiah/snakemake/issues/1953)) ([#2246](https://github.com/jjjermiah/snakemake/issues/2246)) ([0f9c49f](https://github.com/jjjermiah/snakemake/commit/0f9c49fe8643cca0e42e3b091cf9706a7feb877d))
...
* Faster ci test setup  ([#2489](https://github.com/jjjermiah/snakemake/issues/2489)) ([4798e8a](https://github.com/jjjermiah/snakemake/commit/4798e8ac226bded585e9fe31d43ae9e93a598780))
* implement precommand ([#2482](https://github.com/jjjermiah/snakemake/issues/2482)) ([ff0f979](https://github.com/jjjermiah/snakemake/commit/ff0f979b68b1e12be8151c7f5547c6a13ad3ee9a))
...
* introduce --workflow-profile for additional workflow specific profiles that overwrite global profiles; add ability to define key-value CLI flags like --set-threads or --set-resources as multi-level dictionaries in profile config yaml files ([#2310](https://github.com/jjjermiah/snakemake/issues/2310)) ([9675c17](https://github.com/jjjermiah/snakemake/commit/9675c17d4d7cbb95e589767974faa9219dd4154d))
* prepare for storage plugins ([#2454](https://github.com/jjjermiah/snakemake/issues/2454)) ([353a71c](https://github.com/jjjermiah/snakemake/commit/353a71cba1d3dfcc48136b2d6cb744cc1252623b))
* redesigned Snakemake API. It now uses a modern, dataclass based approach ([#2403](https://github.com/jjjermiah/snakemake/issues/2403)) ([2be3bfa](https://github.com/jjjermiah/snakemake/commit/2be3bfa4841967928069a2a024554b8a86b699f1))
...
* support for external executor plugins ([#2305](https://github.com/jjjermiah/snakemake/issues/2305)) ([c9eaa4e](https://github.com/jjjermiah/snakemake/commit/c9eaa4e12e4a348f93e5ea5793faaec1fd547fac))
...
* Tes auth ([#2169](https://github.com/jjjermiah/snakemake/issues/2169)) ([3326a6f](https://github.com/jjjermiah/snakemake/commit/3326a6f7bbaf9c277400625649c3da903e251e2f))
* version specific profile config files (profile/config.v8+.yaml with profile/config.yaml as fallback that matches any version) ([#2498](https://github.com/jjjermiah/snakemake/issues/2498)) ([47e5811](https://github.com/jjjermiah/snakemake/commit/47e581181f952884577f0237a1aa9457ee9554dd))


### Bug Fixes

* 2142 log directive in default target rule ([#2191](https://github.com/jjjermiah/snakemake/issues/2191)) ([86e9624](https://github.com/jjjermiah/snakemake/commit/86e962488dcd346cd0a29a2ff1b2dcd1abafb841))
* adapt linting rule to Python 3.11 ([a3a5c58](https://github.com/jjjermiah/snakemake/commit/a3a5c58cbbbe9a84b7383ce046b5981271288979))
* adapt to changes in snakemake-interface-executor-plugins ([635c68a](https://github.com/jjjermiah/snakemake/commit/635c68abe3c6e01a70803f2423718a99ea056a00))
* add mamba to docker image ([eb0c884](https://github.com/jjjermiah/snakemake/commit/eb0c88495b506300fdf7c1afc4c02d6b91c6a582))
* add missing spaces between lines that get concatenated. ([#2268](https://github.com/jjjermiah/snakemake/issues/2268)) ([7238458](https://github.com/jjjermiah/snakemake/commit/7238458c6d56c5d94787b93668718358ad44e9ef))
* add storage provider args to deploy sources command ([67178e3](https://github.com/jjjermiah/snakemake/commit/67178e31e68dc165c503d49eaf40340a9ad65e90))
* add testcase for script directive to work with Python 3.7 and corresponding fix. ([0b4ae2e](https://github.com/jjjermiah/snakemake/commit/0b4ae2e1155378a78e0786ad4dfd5d44fa41c9ae))
* addressing [#2197](https://github.com/jjjermiah/snakemake/issues/2197) by allowing 256 character account names in slurm ([#2198](https://github.com/jjjermiah/snakemake/issues/2198)) ([ab58c65](https://github.com/jjjermiah/snakemake/commit/ab58c652847c03a9f1529d2d7632f2788a5fadc4))
...
* allow pepfile and pepschema to take pathlib ([#2546](https://github.com/jjjermiah/snakemake/issues/2546)) ([ca91661](https://github.com/jjjermiah/snakemake/commit/ca91661bf2ff215f005e8d9351fa3320d5cf5498))
* also inherit rule proxies if there is no rulename modifier specified in a use rule statement ([#2440](https://github.com/jjjermiah/snakemake/issues/2440)) ([1570289](https://github.com/jjjermiah/snakemake/commit/15702891b31635a79f31e857d09f3e285f71717b))
* always make sure that the original path of source cached files is properly passed into metadata persistence records ([#2179](https://github.com/jjjermiah/snakemake/issues/2179)) ([8bacbd0](https://github.com/jjjermiah/snakemake/commit/8bacbd0b19b0e372f5840b1fab838b79a6bab557))
* assume at most 8GB memory for default resources. This way, we avoid exploding memory requirements for large input files that are very unlikely to be put entirely into memory by any tool. ([11c2ecc](https://github.com/jjjermiah/snakemake/commit/11c2eccfa72a2732d20a66bbf57995ee9dfd14ae))
...
* better message about profile usage upon execution ([#2391](https://github.com/jjjermiah/snakemake/issues/2391)) ([cf8aea5](https://github.com/jjjermiah/snakemake/commit/cf8aea5862767f104c7e03c09369d401f25d50e7))
...
* Bump yte from &gt;=1.0,&lt;2.0 to >=1.5.1,<2.0 ([#2275](https://github.com/jjjermiah/snakemake/issues/2275)) ([8c0b34f](https://github.com/jjjermiah/snakemake/commit/8c0b34f869e4f65ff2e47cf5f1e2863bd104f8e7))
...
* comparison to float in scheduler ([ef44d84](https://github.com/jjjermiah/snakemake/commit/ef44d844b81d671604a1ce285a43ca1d5ea59d96))
* conda env inside script ([#1812](https://github.com/jjjermiah/snakemake/issues/1812)) ([49cac6a](https://github.com/jjjermiah/snakemake/commit/49cac6ac67fba360f2f35be7ab1972b2d8cc1f8b))
...
* detect job paths that leave and then enter a group. Such paths are invalid because then the group depends on itself. ([#2527](https://github.com/jjjermiah/snakemake/issues/2527)) ([5383a4d](https://github.com/jjjermiah/snakemake/commit/5383a4d85f8b7a3fb61fd0b457fcd1d008c2255f))
* Detect pandas availability to select serializer ([#2300](https://github.com/jjjermiah/snakemake/issues/2300)) ([e08a771](https://github.com/jjjermiah/snakemake/commit/e08a771f90aef84f3075e07c8d4e4c0f7881047c))
* do not allow setting benchmark and between-workflow caching for the same rule. The reason is that when the result is taken from cache, there is no way to fill the benchmark file with any reasonable values. ([#2335](https://github.com/jjjermiah/snakemake/issues/2335)) ([e2d64fa](https://github.com/jjjermiah/snakemake/commit/e2d64fad76b8ca1805eeaa48c0bf8d1fb7bf4736))
...
* do not overwrite default resources setting in azure batch executor ([#2395](https://github.com/jjjermiah/snakemake/issues/2395)) ([4aef3b9](https://github.com/jjjermiah/snakemake/commit/4aef3b93ddf029c532fabe38e05c262dd4237b5f))
...
* Enable values with an = sign in default_resources ([#2340](https://github.com/jjjermiah/snakemake/issues/2340)) ([c1c9229](https://github.com/jjjermiah/snakemake/commit/c1c922904f09c133e39872346a541e7cd216d0d2))
* ensure lazy evaluation of resource functions/callables (this also entails, for now, a removal of the thread statistics in the yellow job stats table); further, added some clarifying sentences about resource function evaluation to the docs ([#2356](https://github.com/jjjermiah/snakemake/issues/2356)) ([4c591b7](https://github.com/jjjermiah/snakemake/commit/4c591b72b31d6c6c36b43f1d7773d8317352fbc9))
* ensure that auto deployment of default storage provider works in containers with read-only root home. ([1a347ff](https://github.com/jjjermiah/snakemake/commit/1a347ffd8b2144aee5c35ea17fec2262c5cc9c40))
* ensure that log and benchmark files are uploaded to storage as well ([#2545](https://github.com/jjjermiah/snakemake/issues/2545)) ([6aabb5d](https://github.com/jjjermiah/snakemake/commit/6aabb5db16634c077ba808dbd000a3ed67d6a3c0))
* ensure that targetjob is always forced. This fixes a bug causing run-directive rules to not being executed even when enforced via e.g. -R. ([#2448](https://github.com/jjjermiah/snakemake/issues/2448)) ([b2a60d5](https://github.com/jjjermiah/snakemake/commit/b2a60d5674c84f58c6e48af5d675ce4690a1d625))
...
* Escape workdir paths for potential spaces in paths ([#2196](https://github.com/jjjermiah/snakemake/issues/2196)) ([9261f7e](https://github.com/jjjermiah/snakemake/commit/9261f7ea50a8ae424c015faca73b7811fb51d093))
...
* fix cache handling and unlock handling ([2f4d5e1](https://github.com/jjjermiah/snakemake/commit/2f4d5e11b36f199d3335839e9b5dc5d2094d11f8))
...
* Fix inconsistencies between detailed summary and normal summary ([#2218](https://github.com/jjjermiah/snakemake/issues/2218)) ([d903123](https://github.com/jjjermiah/snakemake/commit/d9031236563b7dd8e31ed27208c9ad39699f765e))
* fix index out of bounds error raised by usage of workflow.source_path called from input or params functions (thanks @AKBrueggemann) ([#2170](https://github.com/jjjermiah/snakemake/issues/2170)) ([cf8e6e8](https://github.com/jjjermiah/snakemake/commit/cf8e6e8995ecb4371c179851f4ded1d01cd1b7f9))
* fix missed wildcard constraints when using local rule inheritance ([#2242](https://github.com/jjjermiah/snakemake/issues/2242)) ([8e94785](https://github.com/jjjermiah/snakemake/commit/8e947858dd510cb4c813f24093b5be843fa4cf6c))
...
* fix nargs definition for --deploy-sources ([fc252c8](https://github.com/jjjermiah/snakemake/commit/fc252c80227e75a4fcf869f828d3c7d5d066f794))
...
* fix pandas import handling in metadata persistence ([27f7b40](https://github.com/jjjermiah/snakemake/commit/27f7b4014eaea66aa4e599aa854dda75822d30a0))
* fix path handling when detective profiles ([fe63881](https://github.com/jjjermiah/snakemake/commit/fe63881371036fc6d55e6a113cb3ed5029b31d2d))
...
* Fix race condition when creating lock directory ([#2225](https://github.com/jjjermiah/snakemake/issues/2225)) ([66ea4d1](https://github.com/jjjermiah/snakemake/commit/66ea4d199e3d9266b1b5fdb8752772e8137ffdea))
* fix scrolling behavior in landing page of report for large workflows ([63c0c31](https://github.com/jjjermiah/snakemake/commit/63c0c31c222a921a843d83e330a6f91e430f209a))
* fix storage handling on windows by converting all paths to posix paths ([#2519](https://github.com/jjjermiah/snakemake/issues/2519)) ([7864a76](https://github.com/jjjermiah/snakemake/commit/7864a76c41ad7839fb3b9aeb1c4468215ba0cb21))
...
* ga4gh executor resources ([#2042](https://github.com/jjjermiah/snakemake/issues/2042)) ([ad6eaef](https://github.com/jjjermiah/snakemake/commit/ad6eaef6bac05d4de682f59d9d4a088f143b5798))
...
* handle different f-string tokens in py3.12 ([#2485](https://github.com/jjjermiah/snakemake/issues/2485)) ([f2c7613](https://github.com/jjjermiah/snakemake/commit/f2c761320a5a73d6027ae3649843e6bf6a24f324))
* handle non-PEP440 versions of apptainer/singulariy ([#2337](https://github.com/jjjermiah/snakemake/issues/2337)) ([dea6ba8](https://github.com/jjjermiah/snakemake/commit/dea6ba8808793b88c7553880bde48711abb037f8))
* handle storage for local jobs; add test case ([6d978ef](https://github.com/jjjermiah/snakemake/commit/6d978ef31060393bd3a69b7973170e3c79473705))
* handling of group jobs when obtaining temp input files ([71be1de](https://github.com/jjjermiah/snakemake/commit/71be1de734032ae8c9e8b07fad57e36b321be421))
...
* import ([#2402](https://github.com/jjjermiah/snakemake/issues/2402)) ([2c831f1](https://github.com/jjjermiah/snakemake/commit/2c831f1fa98813cf5f69ecb046aad1364f514238))
* improved error handling for storage upload; fixed bugs caused by outdated calls to IOFile.exists(). ([720bb84](https://github.com/jjjermiah/snakemake/commit/720bb8400ecf8e6c3caf3ca6b47d7dda4f1f7ba9))
* improved error messages in case of invalid storage queries ([9671fd0](https://github.com/jjjermiah/snakemake/commit/9671fd0770fbe2d79d3546ca5f19c8fc39ffc25a))
* in addition to localrules statement,  infer that job is local if it has any input or output file that is marked as local ([#2541](https://github.com/jjjermiah/snakemake/issues/2541)) ([e8b682b](https://github.com/jjjermiah/snakemake/commit/e8b682be0bd52a01ec3ebdbbcb1ec018950819b2))
...
* limit length of failed logs decorations ([#2125](https://github.com/jjjermiah/snakemake/issues/2125)) ([6fc9243](https://github.com/jjjermiah/snakemake/commit/6fc92434f5aaed60c3d1e62bf4d33c68eeb6ed53))
...
* only consider global wildcard_constraints from the same module ([#2235](https://github.com/jjjermiah/snakemake/issues/2235)) ([c412b71](https://github.com/jjjermiah/snakemake/commit/c412b714a9fbe5cad9ad30de4a0b78b3c13068f6))
...
* only deactivate conda inject envs upon workflow tear down ([#2503](https://github.com/jjjermiah/snakemake/issues/2503)) ([e6dfdd4](https://github.com/jjjermiah/snakemake/commit/e6dfdd49cbaad228827f62a48cfe6419e4c1715e))
...
* Panoptes --wms-monitor-arg ([#2444](https://github.com/jjjermiah/snakemake/issues/2444)) ([98d2bdf](https://github.com/jjjermiah/snakemake/commit/98d2bdfd1e3aeddf189b272d3e4042632248c10f))
...
* print exceptions when job is not a shell job ([#2385](https://github.com/jjjermiah/snakemake/issues/2385)) ([8a37b85](https://github.com/jjjermiah/snakemake/commit/8a37b8584f216ada10caffcbb8b731efd675376a))
...
* proper reuse of rule proxies when importing several times from the same module ([#2404](https://github.com/jjjermiah/snakemake/issues/2404)) ([e867dda](https://github.com/jjjermiah/snakemake/commit/e867dda24dff306f42939ad0d4d93d32ec94f6e5))
...
* quote paths given to singularity in order to ensure that it does not fail when paths contain whitespace ([#2190](https://github.com/jjjermiah/snakemake/issues/2190)) ([a572fb7](https://github.com/jjjermiah/snakemake/commit/a572fb7b8f00e39723cd98d6936f63171b26c8d9))
* raise error if callable is passed to expand. ([#2171](https://github.com/jjjermiah/snakemake/issues/2171)) ([1f28476](https://github.com/jjjermiah/snakemake/commit/1f28476c35dc15a04e1032139b9dab5779801235))
* remote GS builds too many inventories; io:collect_mtime always uses uncached mtime ([#2266](https://github.com/jjjermiah/snakemake/issues/2266)) ([bad9115](https://github.com/jjjermiah/snakemake/commit/bad91152eeb70693e1459324f738a8c481378801))
* remote-azblob-sasToken-Authorization ([#1800](https://github.com/jjjermiah/snakemake/issues/1800)) ([bc854a7](https://github.com/jjjermiah/snakemake/commit/bc854a7e012cac751b708df83378fd5791e6e6fc))
* remove bash completion entrypoint (no longer supported, was too slow to be usable anyway) ([922b53a](https://github.com/jjjermiah/snakemake/commit/922b53aa0cba05da067cc67fccc6852bbc161edb))
...
* remove superfluous dependency ([aad61a0](https://github.com/jjjermiah/snakemake/commit/aad61a0131d7ca0f7393af23b98b1db702cd976d))
* removed distutils from snakemake ([#2312](https://github.com/jjjermiah/snakemake/issues/2312)) ([9b8c362](https://github.com/jjjermiah/snakemake/commit/9b8c3620e8c14e322ba15b7d044b9deab1854b2a))
...
* report spacing ([f3954b3](https://github.com/jjjermiah/snakemake/commit/f3954b33536314e6a252c044eee5f424dd234065))
* require python &gt;=3.7 again (the python 3.9 dependency was unnecessary) ([#2372](https://github.com/jjjermiah/snakemake/issues/2372)) ([0d0e9c4](https://github.com/jjjermiah/snakemake/commit/0d0e9c4cf48a97952464e6da476ed7661d629ce3))
...
* Restore backward compatibility for Google Life Sciences executor ([#2461](https://github.com/jjjermiah/snakemake/issues/2461)) ([5e3a464](https://github.com/jjjermiah/snakemake/commit/5e3a46476d78d5d52340a9ffa327d18a5e7e9828))
...
* rounding for batch calculation ([#2064](https://github.com/jjjermiah/snakemake/issues/2064)) ([cbdbf9b](https://github.com/jjjermiah/snakemake/commit/cbdbf9b648124422ffe16c61b776f92c33c72ef8))
...
* shadow "full" mode ignore symlinks ([#2516](https://github.com/jjjermiah/snakemake/issues/2516)) ([1d58120](https://github.com/jjjermiah/snakemake/commit/1d5812027e5d1a8d5f2e45175fa38d28ca32763e))
* show failed logs in executor testcases ([92f7bf4](https://github.com/jjjermiah/snakemake/commit/92f7bf4b86f491073898b2385c3ed45a557a3b4d))
...
* single line f-string format error in py3.12 ([#2588](https://github.com/jjjermiah/snakemake/issues/2588)) ([87c06c0](https://github.com/jjjermiah/snakemake/commit/87c06c0f5745f577c12db39852c6f763a2d41954))
* Slack log service ([#2537](https://github.com/jjjermiah/snakemake/issues/2537)) ([26eb4ba](https://github.com/jjjermiah/snakemake/commit/26eb4babc28464a24c33d75703e7bf4f15c0e33f))
* slurm batch job status queries ([#2167](https://github.com/jjjermiah/snakemake/issues/2167)) ([0bb69e4](https://github.com/jjjermiah/snakemake/commit/0bb69e429e161bf68b1f3e0b8f6fe3cbd6ed4dae))
...
* Solve apptainer version issue ([#2333](https://github.com/jjjermiah/snakemake/issues/2333)) ([a876e0f](https://github.com/jjjermiah/snakemake/commit/a876e0f5e187168eb269b504918c6aeff1496f16))
* sort report (sub-)categories in lexicographical order ([#2449](https://github.com/jjjermiah/snakemake/issues/2449)) ([d0705ad](https://github.com/jjjermiah/snakemake/commit/d0705adb4702ead9db0c26809859c7b769d800e1))
...
* SyntaxWarnings due to non-raw regex pattern strings ([#2359](https://github.com/jjjermiah/snakemake/issues/2359)) ([a08c0b0](https://github.com/jjjermiah/snakemake/commit/a08c0b071b2f9a9212117bbcf560fa67f1a02178))
...
* unnecessary set Snakefile in AzBatch executor ([#2397](https://github.com/jjjermiah/snakemake/issues/2397)) ([78e6d6e](https://github.com/jjjermiah/snakemake/commit/78e6d6ec6a1ad930e40d6edfe9f7210232a674f2))
* Update __init__.py to move "file" param to "print" ([#2291](https://github.com/jjjermiah/snakemake/issues/2291)) ([92352b6](https://github.com/jjjermiah/snakemake/commit/92352b69d14ef196b0253561c78fa04ffa25d73e))
* update minimum snakemake-interface-storage-plugins version ([0ef7226](https://github.com/jjjermiah/snakemake/commit/0ef72262e29a5b22cdf016a4ab6aba4b8dbc686d))
* updating of non-dict config values gives error ([#2364](https://github.com/jjjermiah/snakemake/issues/2364)) ([b33aeec](https://github.com/jjjermiah/snakemake/commit/b33aeecdf51afba6012007a2b125b9c87b7b98f2))
* Use `job.rule.name` attribute to fill rule field in summary ([#2217](https://github.com/jjjermiah/snakemake/issues/2217)) ([837c3fd](https://github.com/jjjermiah/snakemake/commit/837c3fd97b5a16ddb4f6b74bd2c2b5479d77bd8a))
...
* use temporary directory (faster, more likely local, always writable) for persistence and source cache in case of remote execution without shared fs ([#2502](https://github.com/jjjermiah/snakemake/issues/2502)) ([c8fa7ba](https://github.com/jjjermiah/snakemake/commit/c8fa7ba3ee70c9c62011a3839758a5eb8fde16f8))
...
* wait for logs before showing them on error ([a4ff328](https://github.com/jjjermiah/snakemake/commit/a4ff3280db0beb4f1a077ee880433f767c4ad142))
...
* wms-monitor now gets data in correct json format ([#2347](https://github.com/jjjermiah/snakemake/issues/2347)) ([7fafa7a](https://github.com/jjjermiah/snakemake/commit/7fafa7ace72f8a727457f4abe6db2f9ed2d74d64))
* wrong rule names when nesting module imports ([#1817](https://github.com/jjjermiah/snakemake/issues/1817)) ([65c79a4](https://github.com/jjjermiah/snakemake/commit/65c79a48f956077839bb5ab1ea8d60a5f0ddecab))


### Performance Improvements

* avoid superflous mtime checks when the same file is referred to by multiple jobs ([#2284](https://github.com/jjjermiah/snakemake/issues/2284)) ([eb6e2e1](https://github.com/jjjermiah/snakemake/commit/eb6e2e161f01c61b139d95bcf1ddfa862f8029ba))
...
* added changelog info for &gt;v7.19.1 parsing error of "hh:mm:ss" time format in runtime resource ([#2189](https://github.com/jjjermiah/snakemake/issues/2189)) ([2889f38](https://github.com/jjjermiah/snakemake/commit/2889f3851b64cee7885fbf73f64a453eed5e806a))
...
* basics.rst: suggest VS Code instead of deprecated Atom as IDE ([#2368](https://github.com/jjjermiah/snakemake/issues/2368)) ([1357316](https://github.com/jjjermiah/snakemake/commit/135731605b974915cd2bd78b88a981f974bc7b78))
* Change snakemake-tutorial download link to always be the latest ([#2183](https://github.com/jjjermiah/snakemake/issues/2183)) ([ae8a8f4](https://github.com/jjjermiah/snakemake/commit/ae8a8f4abca233e0c162e3fbd9dfb29ef38f98e6))
* clarify minimum Snakemake version for profiles ([86dc277](https://github.com/jjjermiah/snakemake/commit/86dc277d530a557c9bdd6784b863f63ab859a1c7))
* clarify the channel priority in environment definition deployment.rst ([#2352](https://github.com/jjjermiah/snakemake/issues/2352)) ([76aa964](https://github.com/jjjermiah/snakemake/commit/76aa964c38b4aa069d9cce6f8f43c91c7d496cfb))
* diff 7 and 8 ([#2561](https://github.com/jjjermiah/snakemake/issues/2561)) ([ba22e07](https://github.com/jjjermiah/snakemake/commit/ba22e07af2ab8248888cb57f4bcb8a9eb2623977))
* document name directive with example ([#2534](https://github.com/jjjermiah/snakemake/issues/2534)) ([cce5551](https://github.com/jjjermiah/snakemake/commit/cce555142814f5bd1d73e68b9a17b772454817d4))
...
* fix a copy&paste (?) mistake ([#2386](https://github.com/jjjermiah/snakemake/issues/2386)) ([d878847](https://github.com/jjjermiah/snakemake/commit/d87884749fd9450062f6fde5b7727867396e7a78))
* fix apidocs theme ([1fb5467](https://github.com/jjjermiah/snakemake/commit/1fb546772bc90d96af2a390ced2d02db100ad810))
* fix cli options rendering ([264c1a9](https://github.com/jjjermiah/snakemake/commit/264c1a92e824323b3060192d7a22aeb0c07678e0))
...
* fix formatting ([087fe63](https://github.com/jjjermiah/snakemake/commit/087fe6307a72a577daefcea0cb150f69092138c7))
...
* fix statement about logging ([#2252](https://github.com/jjjermiah/snakemake/issues/2252)) ([56c24b6](https://github.com/jjjermiah/snakemake/commit/56c24b6436cee9a4962d006bb201708c7a37c474))
...
* fix syntax in cluster example ([#2460](https://github.com/jjjermiah/snakemake/issues/2460)) ([64e9645](https://github.com/jjjermiah/snakemake/commit/64e964554748bdee93bad1c7e6cd2924595c414f))
* fix typo (stackoverflow issue) ([#2365](https://github.com/jjjermiah/snakemake/issues/2365)) ([f770984](https://github.com/jjjermiah/snakemake/commit/f7709844cd932465859a2095edafcf9baa8c2bf7))
...
* fix typos in --help ([#2182](https://github.com/jjjermiah/snakemake/issues/2182)) ([09f0cbe](https://github.com/jjjermiah/snakemake/commit/09f0cbe9452a22bde768c7049eeb17f1c93db7ea))
* fixes in migration guide ([f8adefa](https://github.com/jjjermiah/snakemake/commit/f8adefaa605bd87df40440a211276a6825d138ed))
...
* Improve error message when rule contains multiple run/shell/script/notebook/wrapper/template_engine/cwl keywords ([#2186](https://github.com/jjjermiah/snakemake/issues/2186)) ([cd5a3c4](https://github.com/jjjermiah/snakemake/commit/cd5a3c44eace393f24d9338b21d5ef3cb6298126))
* mention maintainers ([be95e25](https://github.com/jjjermiah/snakemake/commit/be95e25d7ee65abe993f08b9d6ca726ee79ec7d4))
* note on using checkpoint mechanism only for input function, not for params or resources. ([#2353](https://github.com/jjjermiah/snakemake/issues/2353)) ([4be2f9d](https://github.com/jjjermiah/snakemake/commit/4be2f9dd9fb41dc169bae068753ceed9552248e7))
* notes on arm based machines in tutorial docs ([0586f04](https://github.com/jjjermiah/snakemake/commit/0586f04d2b03443a25deddd017f303156acdcd9c))
* replace `nosetest` with `pytest` ([#2211](https://github.com/jjjermiah/snakemake/issues/2211)) ([f6b3c47](https://github.com/jjjermiah/snakemake/commit/f6b3c47983bfe436f8ec33ab5830ba577fc38f90))
* **rust:** Fix typo on rust-script version ([#2488](https://github.com/jjjermiah/snakemake/issues/2488)) ([a79dd94](https://github.com/jjjermiah/snakemake/commit/a79dd94f330f1d5c1fba7d16cb5b08bd780d950d))
* update CHANGELOG.md: add minimum Python version bump ([#2370](https://github.com/jjjermiah/snakemake/issues/2370)) ([48e934d](https://github.com/jjjermiah/snakemake/commit/48e934dcf96e4e8fd30c81cab3674583bf049a45))
...
* update docs for azbatch and dockerhub ref ([#2298](https://github.com/jjjermiah/snakemake/issues/2298)) ([908dbf1](https://github.com/jjjermiah/snakemake/commit/908dbf143d4b1625fa6ee80f2b4eb713a6411a3f))
* update misc/vim/Readme with info for packer.nvim ([#2095](https://github.com/jjjermiah/snakemake/issues/2095)) ([32166a7](https://github.com/jjjermiah/snakemake/commit/32166a7fce95312bfa6b6d3ae76bf94accf6d5de))
* Update workflow syntax with priority directive ([#2188](https://github.com/jjjermiah/snakemake/issues/2188)) ([af10db5](https://github.com/jjjermiah/snakemake/commit/af10db56b11badfab2aa4f3aa9fa4bbe3c05fe7d))
